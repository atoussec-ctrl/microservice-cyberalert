...
awslocal sns create-topic --name threat-detected >/dev/null
awslocal sns create-topic --name block-ip-command >/dev/null

echo "[init] Creating SQS Dead Letter Queue..."
awslocal sqs create-queue --queue-name threat-analysis-dlq >/dev/null
